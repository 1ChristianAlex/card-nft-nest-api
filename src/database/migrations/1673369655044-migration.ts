...
export class migration1673369655044 implements MigrationInterface {
    name = 'migration1673369655044'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "card"."transaction" ("id" SERIAL NOT NULL, "wallet" integer NOT NULL DEFAULT '0', "type" text NOT NULL, "status" text NOT NULL DEFAULT 'REQUEST', "transactedAt" TIMESTAMP NOT NULL DEFAULT now(), "deckId" integer, "userId" integer, "transactionId" integer, CONSTRAINT "REL_bdcf2c929b61c0935576652d9b" UNIQUE ("transactionId"), CONSTRAINT "PK_89eadb93a89810556e1cbcd6ab9" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "card"."deck" ("id" SERIAL NOT NULL, "wallet" integer NOT NULL DEFAULT '0', "deckAmount" integer NOT NULL DEFAULT '0', "claims" integer NOT NULL DEFAULT '1', "gambles" integer NOT NULL DEFAULT '8', "nextGamble" TIMESTAMP, "nextDaily" TIMESTAMP, "updatedDate" TIMESTAMP NOT NULL DEFAULT now(), "createAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" integer, CONSTRAINT "PK_99f8010303acab0edf8e1df24f9" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "card"."card" ("id" SERIAL NOT NULL, "name" text NOT NULL, "description" text NOT NULL, "price" integer NOT NULL DEFAULT '30', "likes" integer NOT NULL, "updatedDate" TIMESTAMP NOT NULL DEFAULT now(), "createAt" TIMESTAMP NOT NULL DEFAULT now(), "tierId" integer, "statusId" integer, "userId" integer, "deckId" integer, CONSTRAINT "PK_9451069b6f1199730791a7f4ae4" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "card"."transaction_cards_card" ("transactionId" integer NOT NULL, "cardId" integer NOT NULL, CONSTRAINT "PK_edbc84f28404140eed987cd5a51" PRIMARY KEY ("transactionId", "cardId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_2041c8bc9dcf8e1e0148610d25" ON "card"."transaction_cards_card" ("transactionId") `);
        await queryRunner.query(`CREATE INDEX "IDX_10132a7659a744ff964977a489" ON "card"."transaction_cards_card" ("cardId") `);
        ...
        await queryRunner.query(`ALTER TABLE "card"."transaction" ADD CONSTRAINT "FK_9ccb35d6db3b4c5197e10dfd77c" FOREIGN KEY ("deckId") REFERENCES "card"."deck"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "card"."transaction" ADD CONSTRAINT "FK_605baeb040ff0fae995404cea37" FOREIGN KEY ("userId") REFERENCES "user"."user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "card"."transaction" ADD CONSTRAINT "FK_bdcf2c929b61c0935576652d9b0" FOREIGN KEY ("transactionId") REFERENCES "card"."transaction"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "card"."deck" ADD CONSTRAINT "FK_09e8a376bab70b9737c839b2e24" FOREIGN KEY ("userId") REFERENCES "user"."user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "card"."card" ADD CONSTRAINT "FK_673081effbabe22d74757339c60" FOREIGN KEY ("deckId") REFERENCES "card"."deck"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "card"."transaction_cards_card" ADD CONSTRAINT "FK_2041c8bc9dcf8e1e0148610d257" FOREIGN KEY ("transactionId") REFERENCES "card"."transaction"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "card"."transaction_cards_card" ADD CONSTRAINT "FK_10132a7659a744ff964977a4896" FOREIGN KEY ("cardId") REFERENCES "card"."card"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "card"."transaction_cards_card" DROP CONSTRAINT "FK_10132a7659a744ff964977a4896"`);
        await queryRunner.query(`ALTER TABLE "card"."transaction_cards_card" DROP CONSTRAINT "FK_2041c8bc9dcf8e1e0148610d257"`);
        await queryRunner.query(`ALTER TABLE "user"."user" DROP CONSTRAINT "FK_c28e52f758e7bbc53828db92194"`);
        await queryRunner.query(`ALTER TABLE "card"."card" DROP CONSTRAINT "FK_673081effbabe22d74757339c60"`);
        ...
        await queryRunner.query(`ALTER TABLE "card"."deck" DROP CONSTRAINT "FK_09e8a376bab70b9737c839b2e24"`);
        await queryRunner.query(`ALTER TABLE "card"."transaction" DROP CONSTRAINT "FK_bdcf2c929b61c0935576652d9b0"`);
        await queryRunner.query(`ALTER TABLE "card"."transaction" DROP CONSTRAINT "FK_605baeb040ff0fae995404cea37"`);
        await queryRunner.query(`ALTER TABLE "card"."transaction" DROP CONSTRAINT "FK_9ccb35d6db3b4c5197e10dfd77c"`);
        await queryRunner.query(`ALTER TABLE "card"."thumbs" DROP CONSTRAINT "FK_b5ebcfe8592f6fb3b08871a9d1a"`);
        await queryRunner.query(`DROP INDEX "card"."IDX_10132a7659a744ff964977a489"`);
        await queryRunner.query(`DROP INDEX "card"."IDX_2041c8bc9dcf8e1e0148610d25"`);
