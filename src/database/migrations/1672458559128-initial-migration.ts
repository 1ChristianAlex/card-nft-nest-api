...
export class initialMigration1672458559128 implements MigrationInterface {
  name = 'initialMigration1672458559128';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "card"."tier_entity" ("id" SERIAL NOT NULL, "name" text NOT NULL, "description" text NOT NULL, "value" integer NOT NULL, "updatedDate" TIMESTAMP NOT NULL DEFAULT now(), "createAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_fe143d98a8fd7ecb586fed5bb3f" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "user"."wallet_entity" ("id" SERIAL NOT NULL, "value" integer NOT NULL DEFAULT '0', "deckAmount" integer NOT NULL DEFAULT '0', "claims" integer NOT NULL DEFAULT '1', "gambles" integer NOT NULL DEFAULT '8', "nextGamble" TIMESTAMP NOT NULL, "updatedDate" TIMESTAMP NOT NULL DEFAULT now(), "createAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" integer, "cardId" integer, CONSTRAINT "PK_3e429a1b7a56251b6b8ed06050d" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "card"."card_entity" ("id" SERIAL NOT NULL, "name" text NOT NULL, "description" text NOT NULL, "price" integer NOT NULL DEFAULT '30', "likes" integer NOT NULL, "updatedDate" TIMESTAMP NOT NULL DEFAULT now(), "createAt" TIMESTAMP NOT NULL DEFAULT now(), "tierId" integer, "userId" integer, "walletId" integer, CONSTRAINT "PK_b9a88963999378ac2b88052a3ce" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "user"."wallet_entity" ADD CONSTRAINT "FK_dc5de142ed7750acfd2faea65fb" FOREIGN KEY ("cardId") REFERENCES "card"."card_entity"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "card"."card_entity" ADD CONSTRAINT "FK_3f8c0934ec035f6b7bd97c0a787" FOREIGN KEY ("walletId") REFERENCES "user"."wallet_entity"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "card"."card_entity" DROP CONSTRAINT "FK_3f8c0934ec035f6b7bd97c0a787"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "user"."wallet_entity" DROP CONSTRAINT "FK_dc5de142ed7750acfd2faea65fb"`,
    );
    await queryRunner.query(
